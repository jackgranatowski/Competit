/**
 * Check if a feature flag is on via the  automatic_css_settings object provided by php on window.
 *
 * @param {string} flagName - The flag name in snake_case (e.g. 'use_classic_expansion_character').
 * @returns {boolean}
 */
export function flagIsOn(flagName) {
	return !!window.automatic_css_settings?.flags?.[flagName];
}
