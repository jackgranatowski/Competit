...
class Locale {
	...
	public static function is_locale_fix_enabled() {
		if ( defined( 'AUTOMATICCSS_FIX_LOCALE' ) ) {
			// Legacy flag in use in some environments, can't be removed.
			return true === (bool) constant( 'AUTOMATICCSS_FIX_LOCALE' );
		}
		return Flag::is_on( 'USE_EN_US_LOCALE_FOR_FLOATS' );
	}
}
