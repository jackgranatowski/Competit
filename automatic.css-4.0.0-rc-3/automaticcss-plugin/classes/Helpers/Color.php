...
class Color {
	...
	public function __get( $key ) {
		$allowed_keys = array( 'h', 's', 'l', 's_perc', 'l_perc', 'hex', 'r', 'g', 'b', 'l_oklch', 'c_oklch', 'h_oklch' );
		...
		switch ( $key ) {
			...
			case 'b':
				return round( $rgb['B'] );
			case 'l_oklch':
				return round( $oklch['L'] * 1000 ) / 1000;
			case 'c_oklch':
				return round( $oklch['C'] * 1000 ) / 1000;
			case 'h_oklch':
				return round( $oklch['H'] );
		}
	}
}
