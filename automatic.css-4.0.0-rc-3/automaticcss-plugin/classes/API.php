...
class API {
	 ...
	 */
	public static function get_settings( ?SettingsRepositoryInterface $settings = null ) {
		$database = $settings ?? Database_Settings::get_instance();
	 ...
	 */
	public static function get_setting( $setting_key, ?SettingsRepositoryInterface $settings = null ) {
		$database = $settings ?? Database_Settings::get_instance();
	 ...
	 */
	public static function update_settings( $new_vars, $options = array(), ?SettingsRepositoryInterface $settings = null ) {
		...
		$color_modifiers = array( 'ultra-light', 'light', 'medium', 'dark', 'ultra-dark', 'hover' );
		...
		return $database->save_settings( $save_vars, $options['regenerate_css'] );
	}
	 ...
	 */
	public static function get_all_recipes( ?SettingsRepositoryInterface $settings = null ) {
		return ( new \Automatic_CSS\Model\Config\Expansions( null, $settings ) )->get_all_expansions();
	}
}
