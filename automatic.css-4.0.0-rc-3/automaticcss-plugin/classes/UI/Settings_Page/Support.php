...
class Support {
	...
	public static function settings_page() {
		?>
			<h2>Support</h2>
			<p style="max-width: 80ch;">You can get support by going to our <a href="https://community.automaticcss.com/home" target="_blank">Community Forum</a> or sending an email to <a href="mailto:acss@digitalgravy.co">acss@digitalgravy.co</a></p>
